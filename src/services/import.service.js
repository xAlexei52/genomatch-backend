  ...
  try {
    ...
    const sampleResult = await client.query(
      `INSERT INTO samples (
         ...
         qc_expanded_status, qc_expanded_reads,
         qc_plus_status, qc_plus_reads,
      ...
      [
        ...
        parsedDetails.qcExpandedStatus,
        parsedDetails.qcExpandedReads,
        parsedDetails.qcPlusStatus,
        parsedDetails.qcPlusReads,
